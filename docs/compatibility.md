...
| MCP | Streamable HTTP through official Go SDK v1.4.1 | In-process client/server transport test calls `foundation_info` | Codex extension integration, route-bound project scope, grants, reconnection, and persistent tools |
